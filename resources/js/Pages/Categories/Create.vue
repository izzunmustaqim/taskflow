    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                ...
                <h2 class="font-bold text-2xl text-gray-900 dark:text-white leading-tight">Create Category</h2>
            </div>
        </template>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                ...
                                <input type="text" id="name" v-model="form.name" placeholder="e.g. Work, Personal, Fitness" class="block w-full pl-10 rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900/50 text-gray-900 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm py-2.5 transition-colors" :class="{'border-red-300 focus:border-red-500 focus:ring-red-500': form.errors.name}" autofocus />
                            </div>
